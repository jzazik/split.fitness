...
class StoreWorkoutRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'starts_at' => ['required', 'date', 'after:tomorrow', 'before:+3 months', function ($attribute, $value, $fail) {
    ...
    protected function validateWorkoutOverlap($validator): void
    {
        ...
        $hasOverlap = Workout::where('coach_id', $this->user()->id)
            ...
            ->get()
            ->contains(function ($workout) use ($bufferStart, $bufferEnd) {
                $workoutStart = $workout->starts_at;
                $workoutEnd = $workout->starts_at->copy()->addMinutes($workout->duration_minutes);
    ...
    public function messages(): array
    {
        return [
            ...
            'starts_at.after' => 'Тренировка должна начинаться не раньше завтрашнего дня',
