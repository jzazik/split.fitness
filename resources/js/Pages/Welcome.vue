            ...
            <div class="max-w-2xl w-full text-center">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <button
                            @click="findWorkouts"
                            class="flex-1 bg-primary-600 text-white px-6 py-3 rounded-lg text-lg font-semibold hover:bg-primary-700 transition-colors"
                        >
                            Найти тренировки
                        </button>
                        <button
                            @click="autoDetectLocation"
                            class="flex-1 bg-white border-2 border-primary-600 text-primary-600 px-6 py-3 rounded-lg text-lg font-semibold hover:bg-primary-50 transition-colors"
                        >
